          ...
          <div className="px-4 py-3 border-t bg-white flex-shrink-0">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="w-10 h-10 rounded-xl bg-gradient-to-r from-[#165DFF] to-[#3D7FFF] text-white flex items-center justify-center hover:opacity-90 transition-opacity disabled:opacity-40 disabled:cursor-not-allowed flex-shrink-0"
              >
                {isSending ? (
