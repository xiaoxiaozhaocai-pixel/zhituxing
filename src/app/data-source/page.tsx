    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-bold text-slate-900 mb-4">数据来源声明</h1>
          <p className="text-slate-500">职途星平台关于岗位信息数据来源的公开声明</p>
        </div>

        {/* 主要内容卡片 */}
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 mb-8">
          <h2 className="text-xl font-semibold text-slate-900 mb-6 pb-4 border-b border-slate-100">
            岗位信息数据来源
          </h2>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
          <h3 className="text-lg font-medium text-slate-900 mb-4">相关页面</h3>
