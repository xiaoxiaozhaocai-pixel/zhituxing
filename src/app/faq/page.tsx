...
const faqs = [
  ...
  },
  {
    category: 'platform',
    question: '岗位匹配的准确率如何？',
    answer: '我们基于海量真实招聘JD，结合AI语义匹配和技能图谱分析，匹配准确率远超关键词搜索。系统会综合你的专业、技能、意向城市等多维度信息进行智能推荐。'
  },
  {
    category: 'platform',
    question: '能力测评测的是什么？',
  ...
  },
  {
    category: 'data',
    question: '支持哪些行业和岗位？',
    answer: '目前覆盖互联网、金融、制造、教育、医疗、房地产、零售等多个行业，涵盖技术、产品、运营、市场、职能、设计等主流岗位类型，后续会持续扩展。'
  },
  {
    category: 'data',
    question: '搜索结果按什么排序？',
  ...
  },
  {
    ...
    answer: '免费用户可体验基础功能：每日10次AI对话、基础岗位匹配、查看技能关联、搜索职位、每日3次对话导出。开通会员可解锁无限次AI对话、完整岗位匹配分析、技能图谱全功能、无限次AI模拟面试与PDF报告下载等高级权益。'
  },
  {
    category: 'membership',
    question: '如何取消会员？',
...
category: 'platform',
    ...
    answer: '有两种方式：1. 开通会员享受无限次使用；2. 关注平台活动，获取额外赠送次数。'
  },
  // 隐私安全
  {
    category: 'privacy',
