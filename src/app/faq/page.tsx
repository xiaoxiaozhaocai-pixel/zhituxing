...
const faqs = [
  ...
  },
  {
    ...
    answer: '免费用户享有：职业规划无限次、模拟面试3次、能力测评1次、考研决策3次；会员可享受所有功能无限次使用、可下载PDF格式的职业规划报告、免费下载海量求职资源、优先客服支持等特权。'
  },
  {
    category: 'membership',
    question: '如何取消会员？',
  ...
  // 使用指南
  {
    category: 'guide',
    question: '如何注册职途星账号？',
    answer: '点击首页的「注册」按钮，输入手机号并获取验证码，设置密码后即可完成注册。注册后即可使用各项免费功能（职业规划无限次、模拟面试3次、能力测评1次、考研决策3次）。'
  },
  {
    category: 'guide',
    question: '如何修改个人信息？',
