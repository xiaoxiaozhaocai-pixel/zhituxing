...
import { Check, Target, TrendingUp, Gift, Users, Star, ThumbsUp, ChevronRight, Sparkles, Briefcase, MessageSquare, GraduationCap, Calendar, ArrowRight, Heart } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-blue-300/50 text-xs">© 2025 职途星 All rights reserved.</p>
            </div>
