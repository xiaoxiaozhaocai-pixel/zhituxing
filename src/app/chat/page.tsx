...
import {Send, User as UserIcon, Loader2, Briefcase, GraduationCap, Sparkles, AlertCircle, CheckCircle, ArrowRight, Link as LinkIcon, XCircle, Paperclip, X, FileText, Video, Tv, ChevronUp, ChevronDown, Download, FileText as FileTextIcon, File, Printer, Share2, CheckSquare, Square, Trash2, MessageSquare} from 'lucide-react';
...
function ChatContent() {
  ...
  // 埋点：页面浏览 + tracker初始化
  usePageView('chat', { bot_type: 'xiaozhi' });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-4 text-sm text-gray-500">
          ...
          <Link href="/assistant?bot=interview" className="flex items-center gap-2 hover:text-[#165DFF] transition-colors">
            <div className="w-3 h-3 rounded-full bg-gradient-to-r from-green-500 to-green-600"></div>
            <span>模拟面试官</span>
          </Link>
          <Link href="/assistant?bot=career" className="flex items-center gap-2 hover:text-[#165DFF] transition-colors">
            <div className="w-3 h-3 rounded-full bg-gradient-to-r from-blue-500 to-blue-600"></div>
            <span>职业生涯规划</span>
          </Link>
          <Link href="/assistant?bot=decision" className="flex items-center gap-2 hover:text-[#FF7D00] transition-colors">
