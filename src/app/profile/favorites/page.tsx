    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-slate-600 mb-4">请先登录查看收藏</p>
          <a
            href="/auth"
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {favorites.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-2xl border-2 border-dashed border-slate-200">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">还没有收藏任何岗位</h3>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="font-semibold text-slate-900">{favorite.jobTitle}</h3>
                    </div>
                    ...
                    {(() => {
                      ...
                      return display ? (
                        <p className="text-slate-600 mb-2">{display}</p>
                      ) : null;
                    })()}
