...
import { CANDIDATE_UNLOCK_PRICE, CANDIDATE_UNLOCK_PRICE_TEXT } from '@/lib/config';
import {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">{CANDIDATE_UNLOCK_PRICE_TEXT} · 24 小时内重复查看免费</p>
        </div>
          ...
          {stage === 'confirm' && (
            <>
              ...
              <div className="bg-[#FF7D00]/5 border border-[#FF7D00]/20 rounded-lg px-3 py-2 mb-4 text-sm flex items-center justify-between">
                ...
                <span className="font-semibold text-[#FF7D00]">1 条 · ¥{CANDIDATE_UNLOCK_PRICE}</span>
              </div>
