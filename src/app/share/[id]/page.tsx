  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        {data.mode === 'curated' && (
          <div className="mb-4 flex items-center gap-2 px-4 py-2.5 bg-[#165DFF]/5 border border-[#165DFF]/15 rounded-xl">
            <svg className="w-4 h-4 text-[#165DFF] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
