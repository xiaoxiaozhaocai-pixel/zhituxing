...
export const SUBTEXT_GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  '弹性工作节奏': { category: 'workplace', surface: '公司说「弹性工作节奏」', meaning: '常是「弹性加班」，下班没准点、工时难算。', risk: 'medium', advice: '问清打卡与加班补偿，别被「弹性」带偏。' },
    ...
    '弹性办公': {
      category: 'jd',
      surface: '写的是「弹性办公」',
      meaning: '可能允许灵活时段，也可能无固定工时、隐性加班。',
      risk: 'medium',
      advice: '问清打卡与工时制度，别把「弹性」当福利。',
    },
    '优秀者可面议': {
      category: 'jd',
      surface: '写的是「优秀者面议」',
      meaning: '常是薪资不高的遮羞布，或有谈判空间。',
      risk: 'medium',
      advice: '主动问薪资带宽，别只等「面议」。',
    },
    '你想成为什么样的人': {
      category: 'interview',
      surface: '问「理想/未来」',
      meaning: '考察价值观与目标，判断匹配与稳定性。',
      risk: 'low',
      advice: '讲清楚而真实的成长方向，贴合岗位别空喊。',
    },
    '你会怎么学习新东西': {
      category: 'interview',
      surface: '问「学习方式」',
      meaning: '考学习能力与方法，判断是否可快速上手。',
      risk: 'low',
      advice: '给具体的学习方法+案例，别只说「我会学」。',
    },
    '你对岗位的理解': {
      category: 'interview',
      surface: '问「岗位理解」',
      meaning: '看是否做足功课与匹配度，也是考招聘判断。',
      risk: 'medium',
      advice: '讲清岗位职责、所需能力与你的匹配，别泛泛。',
    },
    '在校期间担任': {
      category: 'resume',
      surface: '写的是「在校期间担任」',
      meaning: '看学生经历，含金量取决于实际贡献。',
      risk: 'low',
      advice: '讲清职务内容与产出，别只看「担任过」。',
    },
    '有一定基础': {
      category: 'resume',
      surface: '写的是「有一定基础」',
      meaning: '自谦或底气不足，需要用具体佐证撑起来。',
      risk: 'medium',
      advice: '用课程、项目、工具实操证明，别停留在「基础」。',
    },
    '性格开朗': {
      category: 'resume',
      surface: '写的是「性格开朗」',
      meaning: '虚词，偏销售/服务岗，但缺具体支撑。',
      risk: 'low',
      advice: '用沟通/协作案例佐证，别只写形容词。',
    },
    '责任心强': {
      category: 'resume',
      surface: '写的是「责任心强」',
      meaning: '万能词，需落到具体负责或兜底的事例。',
      risk: 'medium',
      advice: '用负责任的具体事例证明，别只剩口号。',
    },
    '时间观念': {
      category: 'resume',
      surface: '写的是「时间观念强」',
      meaning: '偏执行，需有按时交付的实例。',
      risk: 'low',
      advice: '用项目节点或守时的成果支撑。',
    },
    '你再想想': {
      category: 'workplace',
      surface: '说「你再想想」',
      meaning: '可能是让你别急着定，或在给你施加压力。',
      risk: 'medium',
      advice: '冷静评估真实诉求，别被「再想想」拖着。',
    },
    '这个不太行': {
      category: 'workplace',
      surface: '说「这个不太行」',
      meaning: '委婉否定，可能想让你再改或换方向。',
      risk: 'medium',
      advice: '弄清具体不满在哪，对症改，别硬扛。',
    },
    '先放着': {
      category: 'workplace',
      surface: '说「先放着」',
      meaning: '可能是缓办，也可能优先级低、短期不做。',
      risk: 'low',
      advice: '确认优先级与时限，别真的搁置到丢。',
    },
    '我跟你说个事': {
      category: 'workplace',
      surface: '说「跟你说个事」',
      meaning: '可能话里有话，需认真听再做判断。',
      risk: 'medium',
      advice: '先听完再回应，别急着打断或表态。',
    },
    '你多担待': {
      category: 'workplace',
      surface: '说「你多担待」',
      meaning: '想让你让步/背些不便，用客套软化边界。',
      risk: 'high',
      advice: '弄清要你担什么，守住底线再答应。',
    },
    '就按这个办': {
      category: 'workplace',
      surface: '说「就按这个办」',
      meaning: '让你执行，可能是拍板也可能甩责。',
      risk: 'medium',
      advice: '确认是正式决策还是试探，别照单全收。',
    },
    '晋升机制': {
      category: 'jd',
      surface: '写的是「晋升机制清晰」',
      meaning: '可能只是空喊，需问清周期、标准与实际案例。',
      risk: 'low',
      advice: '问清晋升周期、考核标准、最近晋升案例。',
    },
    '导师制': {
      category: 'jd',
      surface: '写的是「导师制/带教」',
      meaning: '说明有人带，但也可能师傅忙、带教流于形式。',
      risk: 'low',
      advice: '问清带教安排与频率，判断是否真能学到。',
    },
    '你遇到最棘手的事': {
      category: 'interview',
      surface: '问「最棘手事/冲突」',
      meaning: '考你如何应对难题与冲突，也是压力测试。',
      risk: 'medium',
      advice: '讲清难题+你的处理+结果，别回避。',
    },
    '你怎么看待失败': {
      category: 'interview',
      surface: '问「失败经历」',
      meaning: '考抗挫与复盘能力，也是考察真实性。',
      risk: 'medium',
      advice: '讲真实失败+复盘+改进，别只挑轻的说。',
    },
    '你有啥优势': {
      category: 'interview',
      surface: '问「你的优势」',
      meaning: '看你自我认知与匹配度，考验表达与洞察。',
      risk: 'low',
      advice: '结合岗位说可验证的优势，别空泛。',
    },
    '你能长期做吗': {
      category: 'interview',
      surface: '问「能稳定/长期吗」',
      meaning: '担心你干不久，也是评估稳定与忠诚度。',
      risk: 'medium',
      advice: '讲清你的节奏与打算，别过度承诺。',
    },
    '你投了多少家': {
      category: 'interview',
      surface: '问「投了多少家」',
      meaning: '摸你的求职热度与处境，判断紧迫度。',
      risk: 'medium',
      advice: '如实但不过度，讲清匹配与专注度。',
    },
    '主要课程': {
      category: 'resume',
      surface: '写的是「主要课程」',
      meaning: '列课程表刷篇幅，无实际区分度。',
      risk: 'low',
      advice: '挑与岗位强相关的几门+收获即可。',
    },
    '获得过奖项': {
      category: 'resume',
      surface: '写的是「获得过奖项」',
      meaning: '奖项多但含金量需细看，可能是凑数。',
      risk: 'medium',
      advice: '挑含金量高的讲，附具体名次与范围。',
    },
    '兴趣广泛': {
      category: 'resume',
      surface: '写的是「兴趣广泛」',
      meaning: '虚词，无区分度，反而可能分散。',
      risk: 'low',
      advice: '除非和岗位相关，否则少写。',
    },
    '做事踏实': {
      category: 'resume',
      surface: '写的是「做事踏实」',
      meaning: '偏执行，需有负责任的具体事例。',
      risk: 'medium',
      advice: '用按时交付/兜底的例子证明。',
    },
    '这个先别动': {
      category: 'workplace',
      surface: '说「这个先别动」',
      meaning: '可能顺序问题或涉及敏感，需确认。',
      risk: 'medium',
      advice: '问清原因与优先级，别擅自处理。',
    },
    '这我负责': {
      category: 'workplace',
      surface: '说「这我负责」',
      meaning: '主动揽责，但也可能是不想让你插手或另有算盘。',
      risk: 'medium',
      advice: '确认职责边界与授权，别被「负责」套住。',
    },
    '你别多想': {
      category: 'workplace',
      surface: '说「你别多想」',
      meaning: '可能真有猫腻让你别深究，或只是安抚。',
      risk: 'high',
      advice: '保持判断，别被「别多想」压住。',
    },

    '定期体检': {
      category: 'jd',
      surface: '福利里提到每年定期体检。',
      meaning: '注意体检覆盖的是入职例行还是年度福利，项目范围（含家属或额外加项）往往没写全。',
      risk: 'low',
      advice: '提前问清体检频次、覆盖范围与是否额外福利，别默认成「免费全面体检」。',
    },
    '法定节假日': {
      category: 'jd',
      surface: '福利标注「法定节假日正常休息」。',
      meaning: '法定节假日本来就该休，专门写出来往往暗示平时加班多，靠节假日作补偿。',
      risk: 'medium',
      advice: '别被「法定休」感动，重点反问平时双休是否保障、加班频率与调休规则。',
    },
    '全勤奖': {
      category: 'jd',
      surface: '薪资结构里写了全勤奖。',
      meaning: '全勤奖常是拿基本工资一部分拆出来压考勤，缺勤一次可能整月取消。',
      risk: 'medium',
      advice: '问清全勤奖占工资比例、缺勤扣罚规则，避免当成额外收入。',
    },
    '餐补': {
      category: 'jd',
      surface: '福利含餐补或包吃。',
      meaning: '餐补金额通常偏低（一天十几到几十），远低于实际伙食开销，有的视作工资组成部分。',
      risk: 'low',
      advice: '折算成月薪实际涨幅对比同类岗位，别把餐补当成重要福利。',
    },
    '带薪旅游': {
      category: 'jd',
      surface: '福利标注「员工旅游/带薪旅游」。',
      meaning: '旅游可能是占用周末或强制团建，真正福利性质看是否自愿、是否占用私人时间。',
      risk: 'medium',
      advice: '问清旅游频次、是否占用休息日、能否自带家属，判断是真福利还是变相团建。',
    },
    '新人奖': {
      category: 'jd',
      surface: '福利含「优秀新人奖/新人激励」。',
      meaning: '新人奖是筛选优秀者的激励，名额有限，别把它当作人人可得的基础福利。',
      risk: 'low',
      advice: '了解获奖比例与评定标准，作为额外的成长激励而非期望的固定回报。',
    },
    '你之前的离职原因': {
      category: 'interview',
      surface: '面试官问上一份工作的离职原因。',
      meaning: '考察你的稳定性、是否因冲突或能力问题离开，以及你对前东家的态度。',
      risk: 'medium',
      advice: '给理性原因为宜（发展空间/客观变动），避免抱怨前东家或显示频繁跳槽。',
    },
    '你怎么看待我们公司的竞争': {
      category: 'interview',
      surface: '面试官问你怎么看行业竞争/竞品。',
      meaning: '考察你对行业的了解与判断，以及是否真做过功课，而非背套话。',
      risk: 'medium',
      advice: '先讲行业格局再讲公司差异化，展示你读了公司/竞品资料，避免空泛吹捧。',
    },
    '你期待的领导类型': {
      category: 'interview',
      surface: '面试官问你期待什么样的直属领导。',
      meaning: '考察你对管理风格的偏好，也侧面看你能否适应公司现有管理文化。',
      risk: 'low',
      advice: '讲「期待目标明确、能给反馈、共同成长」这类中性偏好，避免挑刺或提苛刻要求。',
    },
    '你多久能到岗': {
      category: 'interview',
      surface: '面试官问你多久能到岗/什么时候入职。',
      meaning: '到岗时间是录用决定的重要变量，越快往往越有优势。',
      risk: 'low',
      advice: '给出确定、可兑现的到岗节点，体现规划性与承诺度，别含糊「尽快」。',
    },
    '担任职位': {
      category: 'resume',
      surface: '简历写了「担任xx职位/职务」。',
      meaning: '「职位」和「职责/成果」是两回事，单写头衔无实绩支撑。',
      risk: 'medium',
      advice: '补充量化结果或项目细节，让「职位」落到「做了什么、带来什么」上。',
    },
    '毕业设计': {
      category: 'resume',
      surface: '简历写了毕业设计/课程设计。',
      meaning: '毕业设计是学生最硬的工程/研究证据，但很多人只写题目不写内容。',
      risk: 'low',
      advice: '写清课题、解决什么问题、用的方法工具、取得的可验证结果。',
    },
    '学生会': {
      category: 'resume',
      surface: '简历提到学生会/社团经历。',
      meaning: '学生会经历是组织协调力的佐证，但需落到具体策划/落地成果。',
      risk: 'medium',
      advice: '写清担任角色、组织过什么活动、影响多少人，避免「成员」一笔带过。',
    },
    '志愿者经历': {
      category: 'resume',
      surface: '简历写了志愿服务经历。',
      meaning: '志愿服务体现责任感，但招聘方更看重与岗位能力的关联。',
      risk: 'medium',
      advice: '与求职无关就放课外活动区；若有关（如公益项目运营），突出可量化贡献。',
    },
    '英语水平': {
      category: 'resume',
      surface: '简历写了英语水平（CET-4/6）。',
      meaning: '英语等级是门槛项，高分才有区分度，对HR/出海岗尤其重要。',
      risk: 'low',
      advice: '写清具体级别分数或口语/读写能力，别只写「英语良好」。',
    },
    '主修课程': {
      category: 'resume',
      surface: '简历写了主修课程/核心课程。',
      meaning: '列课程是基础，需体现与你目标岗位的匹配，而非罗列课单。',
      risk: 'low',
      advice: '挑与岗位最相关的几门专业课，并说明课程内容如何支撑你的能力。',
    },
    '这个不急明天再弄': {
      category: 'workplace',
      surface: '领导说「这个不急，明天再弄」。',
      meaning: '往往意味着优先级下降，但也可能是口头安抚，实际仍要跟进。',
      risk: 'medium',
      advice: '确认真实优先级与截止时间，别真的放下；重要事项主动同步进度。',
    },
    '你挺有想法的': {
      category: 'workplace',
      surface: '同事或领导说「你挺有想法的」。',
      meaning: '可能真心认可，也可能是「建议不错但先放放」的含蓄表达。',
      risk: 'medium',
      advice: '顺势把想法落成可执行建议并询问资源支持，别停在「被夸」阶段。',
    },
    '总得有人背锅': {
      category: 'workplace',
      surface: '项目出问题时有人倾向「总得有人背锅」。',
      meaning: '团队责任文化差、互相甩锅的信号，工作安全感可能偏低。',
      risk: 'high',
      advice: '在责任不清的项目里做好过程留痕，避免无依据接锅；长期需评估团队风气。',
    },
    '他其实挺忙的': {
      category: 'workplace',
      surface: '领导解释某同事「他其实挺忙的」。',
      meaning: '可能给该同事开脱，也可能暗示你不该催、要自己消化。',
      risk: 'medium',
      advice: '理解分工边界，必要时用书面形式说清依赖与风险，避免责任模糊。',
    },
    '今天就到这': {
      category: 'workplace',
      surface: '领导说「今天就到这，明天继续」。',
      meaning: '可能是自然收尾，也可能是暂停推进、后续再说，需确认下一步安排。',
      risk: 'low',
      advice: '确认明日优先事项与负责人，别让「今天到这」变成「没人管这事」。',
    },
    '你先熟悉下': {
      category: 'workplace',
      surface: '领导安排「你先熟悉下xx/团队」。',
      meaning: '可能是给你适应期，也可能暂时没有具体任务要你，需主动找事干。',
      risk: 'medium',
      advice: '主动要资料、了解流程并同步学习计划，别被动等待安排。',
    },
};
