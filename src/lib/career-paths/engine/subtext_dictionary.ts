...
export const SUBTEXT_GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  '弹性工作节奏': { category: 'workplace', surface: '公司说「弹性工作节奏」', meaning: '常是「弹性加班」，下班没准点、工时难算。', risk: 'medium', advice: '问清打卡与加班补偿，别被「弹性」带偏。' },
    ...
    '包住': {
      category: 'jd',
      surface: '福利写了「包住/提供住宿」。',
      meaning: '住宿条件可能是多人间、宿舍，或需扣水电费，不一定等于独立公寓。',
      risk: 'medium',
      advice: '问清住宿类型、是否收费、水电是否自理、通勤距离，别默认成免费公寓。',
    },
    '加班费': {
      category: 'jd',
      surface: '薪资说明里写了加班费。',
      meaning: '加班费计算基数、是否强制加班、调休制度都影响真实收益。',
      risk: 'medium',
      advice: '问清加班费基数与倍率、能否调休，判断是「真补偿」还是「顺便一提」。',
    },
    '转正考核': {
      category: 'jd',
      surface: '写了「试用期后转正考核」。',
      meaning: '试用期可能有淘汰风险，考核标准若不透明会没底。',
      risk: 'high',
      advice: '问清转正考核的具体标准、指标与期限，提前对齐避免试用期被动。',
    },
    '十三薪': {
      category: 'jd',
      surface: '薪资写了「十三薪/年终双薪」。',
      meaning: '「十三薪」可能是固定月薪的一次性发放，也可能与绩效绑定，甚至要年后才发。',
      risk: 'medium',
      advice: '确认十三薪是否固定、发放时间、是否与绩效挂钩，别当成年终奖。',
    },
    '五险': {
      category: 'jd',
      surface: '福利写了「缴纳五险/社保」。',
      meaning: '五险是法定必须交的，写出来只是保底；社保基数和补缴情况更关键。',
      risk: 'low',
      advice: '问清社保基数按多少交、是否入职即缴，避免「写了但按最低缴」。',
    },
    '你的座右铭是什么': {
      category: 'interview',
      surface: '面试官问你座右铭/人生信条。',
      meaning: '考察你的价值观是否与岗位匹配，也看你能否自圆其说。',
      risk: 'low',
      advice: '选一个能落到工作态度的信条，并说明它如何指导你的实际行动。',
    },
    '你怎么看待团队合作': {
      category: 'interview',
      surface: '面试官问你怎么看待团队合作。',
      meaning: '考察协作意识，也侧面判断你是否能融入团队文化。',
      risk: 'low',
      advice: '用具体合作经历说明分工、沟通与结果，避免只讲「要团结」。',
    },
    '你接受轮岗吗': {
      category: 'interview',
      surface: '面试官问你能否接受轮岗/调岗。',
      meaning: '轮岗可能是培养也可能是「哪里缺人去哪里」，需弄清方向。',
      risk: 'medium',
      advice: '表达愿意学习的同时，问清轮岗方向、周期与转回机制。',
    },
    '你怎么安排优先级': {
      category: 'interview',
      surface: '面试官问你怎么安排任务优先级。',
      meaning: '考察你的时间管理与判断力，看能否区分重要/紧急。',
      risk: 'low',
      advice: '给「先重要紧急、再重要不紧急、用工具排期」的方法，并举例。',
    },
    '你最大的优势是什么': {
      category: 'interview',
      surface: '面试官问你最大的优势是什么。',
      meaning: '考察自我认知与岗位匹配，需要具体而非空泛。',
      risk: 'low',
      advice: '选一个与岗位强相关的优势，用经历+结果佐证，别只给形容词。',
    },
    '你对加班文化怎么看': {
      category: 'interview',
      surface: '面试官问你对加班的看法。',
      meaning: '试探你对工作强度、生活节奏的接受度及真实态度。',
      risk: 'medium',
      advice: '表达理解业务需要、但重视效率与结果导向，避免强表态「愿意无限加」。',
    },
    '实习证明': {
      category: 'resume',
      surface: '简历写了「获得实习证明」。',
      meaning: '实习证明只证明你实习过，不代表能力；需体现具体产出。',
      risk: 'medium',
      advice: '补充实习期间做的项目、解决的问题与成果，让「证明」有内容。',
    },
    '暑期实践': {
      category: 'resume',
      surface: '简历写了暑期实践/社会实践。',
      meaning: '实践经历是组织与应变能力的体现，但需落到具体做了什么。',
      risk: 'medium',
      advice: '写清实践主题、你担任的角色、解决的现实问题与可量化成果。',
    },
    '校内竞赛': {
      category: 'resume',
      surface: '简历写了参加校内竞赛/比赛。',
      meaning: '竞赛奖项含金量看级别与参与深度，参赛≠获奖。',
      risk: 'low',
      advice: '注明竞赛级别、你的分工与结果，避免只写「参加」。',
    },
    '软件技能': {
      category: 'resume',
      surface: '简历写了掌握xx软件/工具。',
      meaning: '技能需能与岗位实际挂钩，单独列软件清单说服力有限。',
      risk: 'low',
      advice: '结合具体任务说明你用该技能解决了什么问题，而非罗列工具名。',
    },
    '结课论文': {
      category: 'resume',
      surface: '简历写了课程结课论文/报告。',
      meaning: '课程论文是学术与逻辑训练的体现，但偏理论需点到岗位相关。',
      risk: 'low',
      advice: '若与求职方向相关，写清选题、你的核心观点与研究方法。',
    },
    '这事再议': {
      category: 'workplace',
      surface: '领导/同事说「这事再议/先放放」。',
      meaning: '可能暂缓，也可能是委婉拒绝，需判断真实意图。',
      risk: 'medium',
      advice: '确认是否真的暂缓、何时跟进，重要事项主动记录避免被遗忘。',
    },
    '你先看看': {
      category: 'workplace',
      surface: '领导说「你先看看这份材料/方案」。',
      meaning: '可能是让你先熟悉，也可能是把工作推给你，要主动消化并反馈。',
      risk: 'low',
      advice: '主动梳理重点、提出疑问或初步方案，别被动「看看了事」。',
    },
    '辛苦你': {
      category: 'workplace',
      surface: '同事/领导说「辛苦你了」。',
      meaning: '可能是感谢，也可能只是客气，不代表任务结束或成果被认可。',
      risk: 'low',
      advice: '正常回谢即可，若重要事项再输出书面总结确认闭环。',
    },
    '咱们开个短会': {
      category: 'workplace',
      surface: '领导说「咱们开个短会/碰一下」。',
      meaning: '「短会」未必真短，且可能临时占用时间，需带准备。',
      risk: 'low',
      advice: '提前带上资料和议题，会后输出结论与分工，避免会而不议。',
    },
    '上市公司': {
      category: 'jd',
      surface: 'JD/公司背景写明「上市公司/上市集团」。',
      meaning: '暗示公司有资本背书、流程规范，但未必待遇更好，可能是稳定性导向或股权激励点。',
      risk: 'low',
      advice: '可核实公司真实市值与业绩，不因「上市」盲目加分，结合具体岗位的薪资与发展判断。',
    },
    '国企编制': {
      category: 'jd',
      surface: 'JD/招聘说明含「国企编制/事业编制」。',
      meaning: '强调稳定、福利规范，但可能工资偏低、晋升按资历，编制=旱涝保收与流动性低并存。',
      risk: 'medium',
      advice: '确认是正式编制还是派遣/合同工，结合薪资和职业成长速度权衡稳定与天花板。',
    },
    '实习留用': {
      category: 'jd',
      surface: 'JD含「实习留用/实习可转正」。',
      meaning: '暗示先低成本考察，转正有名额与考核门槛，「留用」未必等于录用。',
      risk: 'medium',
      advice: '问清转正比例、考核标准与时间节点，别把「留用机会」当「保底offer」。',
    },
    '行业标杆': {
      category: 'jd',
      surface: 'JD/公司介绍含「行业标杆/龙头企业」。',
      meaning: '公司自评行业地位，用于提升吸引力，但「标杆」是宣传语，需核实真实市占与口碑。',
      risk: 'low',
      advice: '用公开数据/榜单核验其行业地位，同时看它招聘门槛是否配得上「标杆」名头。',
    },
    '带团队': {
      category: 'jd',
      surface: 'JD含「带团队/管理团队」。',
      meaning: '岗位有管理职责或带教角色，可能意味着要承担团队绩效与协调成本，不全是权力。',
      risk: 'medium',
      advice: '问清团队规模、汇报关系与考核，确认自己是否具备管理能力与意愿再投。',
    },
    '你为什么选择这个行业': {
      category: 'interview',
      surface: '面试官问「你为什么选择这个行业」。',
      meaning: '考察你的选择动机与稳定度，也观察你是否对行业有真实了解、还是海投。',
      risk: 'low',
      advice: '用行业趋势+个人兴趣+能力匹配三点作答，避免只说「工资高」「好找工作」。',
    },
    '你如何看待频繁跳槽': {
      category: 'interview',
      surface: '面试官问「你如何看待频繁跳槽」。',
      meaning: '测试你的稳定性与忠诚度，也警惕你是不是「骑驴找马」或难以沉淀。',
      risk: 'high',
      advice: '表态理解跳槽但强调自己求发展而非盲动，如有跳槽史给出真实且自洽的成长逻辑。',
    },
    '你如何安排时间': {
      category: 'interview',
      surface: '面试官问「你如何安排时间/管理多任务」。',
      meaning: '考察项目管理与优先级判断能力，想看你是否高效、有条理。',
      risk: 'medium',
      advice: '用「排优先级+定节点+留缓冲」的具体方法作答，可举例证明可落地。',
    },
    '你擅长什么': {
      category: 'interview',
      surface: '面试官问「你擅长什么/你的强项」。',
      meaning: '想快速定位你的差异化价值，判断你能为团队解决什么问题。',
      risk: 'low',
      advice: '给1-2个岗位相关的核心强项+可验证的成果，别空泛说「学习能力强」。',
    },
    '你现在的工作状态': {
      category: 'interview',
      surface: 'HR问「你现在的工作/学习状态」。',
      meaning: '确认你能否尽快到岗、是否有空档期或已离职，也评估你的求职紧迫度。',
      risk: 'low',
      advice: '如实说明当前状态与可到岗时间，卡住应届生就问清在校课业是否影响实习/入职。',
    },
    '你未来的计划是什么': {
      category: 'interview',
      surface: '面试官问「你未来的计划是什么」。',
      meaning: '考察你的职业规划与岗位匹配度，判断你是否会长期做下去或中途跳走。',
      risk: 'medium',
      advice: '把你的计划与岗位发展路径对齐，表明有清晰方向且愿意在此投入，但别画大饼。',
    },
    '英语四级': {
      category: 'resume',
      surface: '简历写「英语四级」。',
      meaning: '表明基础外语能力达标，是常规门槛证书，四级在求职中多为硬件底线而非加分项。',
      risk: 'low',
      advice: '若岗位需要熟练外语，别只写四级，补上实际读写/口语沟通证明更有说服力。',
    },
    '英语六级': {
      category: 'resume',
      surface: '简历写「英语六级」。',
      meaning: '相对四级更具竞争优势，能通过多数外企/出海岗位的硬门槛筛选。',
      risk: 'low',
      advice: '可标注分数或口语场景，把证书转化为「能处理英文文档/邮件/汇报」的具体能力。',
    },
    '计算机二级': {
      category: 'resume',
      surface: '简历写「计算机二级」。',
      meaning: '证明基础办公软件与计算机操作能力，属于较基础的技能证书。',
      risk: 'low',
      advice: '若岗位涉数据分析/开发，二三级价值有限，换成「熟练使用XX/掌握XX」更具体。',
    },
    '普通话': {
      category: 'resume',
      surface: '简历写「普通话二级甲等/乙等」。',
      meaning: '证明口头表达与吐字规范，对需普通话等级的职业（教师/播音/客服）有门槛意义。',
      risk: 'low',
      advice: '若岗位对表达有要求可保留；普通岗位不必重点突出，可作为辅助亮点。',
    },
    '通过考试': {
      category: 'resume',
      surface: '简历写「通过XX考试/考证中」。',
      meaning: '表明有专业认证在考或已过，体现学习投入，但尚需确认最终拿证。',
      risk: 'low',
      advice: '写清具体考试名称与通过状态，未完全拿证规范标「已过合格线」，避免注水。',
    },
    '持有证书': {
      category: 'resume',
      surface: '简历写「持有XX证书/资格证书」。',
      meaning: '强调技能背书与合规性，但要区分含金量高低，避免堆砌无关证书。',
      risk: 'low',
      advice: '只写与岗位强相关的证书并说明用途，无关证书反而稀释专业性。',
    },
    '按我说的做': {
      category: 'workplace',
      surface: '领导说「别问那么多，按我说的做」。',
      meaning: '上级要你执行而非质疑，可能情绪化或强势，容错空间小，需谨慎。',
      risk: 'medium',
      advice: '先承接执行，同时用「我理解你的目标是这样，我这样落地可以吗」温和确认，避免硬顶。',
    },
    '不要问为什么': {
      category: 'workplace',
      surface: '领导说「不要问为什么，照做」。',
      meaning: '强调单向下达指令，可能是高压或信息不对称，你需要自行判断风险。',
      risk: 'high',
      advice: '若涉及你不可控/违规的事项，保留书面记录并明确边界，必要时向前确认清楚。',
    },
    '你知道该怎么做了吧': {
      category: 'workplace',
      surface: '领导说「你应该知道怎么做了吧」。',
      meaning: '看似引导，实则要你主动补位，是测试你的理解与主动性，答错就难做。',
      risk: 'medium',
      advice: '先复述你的理解请对方确认，不要盲目动手，避免理解偏差导致返工。',
    },
    '明白我的意思吗': {
      category: 'workplace',
      surface: '同事/领导问「你明白我的意思吗」。',
      meaning: '可能你真的没懂，也可能是强调听清楚、别漏掉重点，需你确认对齐。',
      risk: 'low',
      advice: '用一句话复述你的理解，确认一致；确实不懂就大方再问，别假装明白。',
    },
    '听明白了吗': {
      category: 'workplace',
      surface: '领导说「听明白了吗」。',
      meaning: '要求你确认接收并执行，带有强调意味，需你给出明确回应。',
      risk: 'low',
      advice: '回应「听明白了+复述要点」，展现执行力，同时为后续结果负责。',
    },
    '低调一点': {
      category: 'workplace',
      surface: '同事/领导说「低调一点」。',
      meaning: '提醒你收敛锋芒或别声张，可能涉及办公室政治、成果归属敏感。',
      risk: 'medium',
      advice: '适当收敛但别自我否定，关键成果该记录就记录，避免被「低调」埋没。',
    },
    '交通补贴': {
      category: 'jd',
      surface: 'JD含「交通补贴/话费补贴」。',
      meaning: '表示有差旅/通勤相关补贴，但要看清标准与报销流程，可能只管部分开销。',
      risk: 'low',
      advice: '问清补贴标准、发放方式与是否含通勤/出差，别把「有补贴」当「全包」。',
    },
    '高温补贴': {
      category: 'jd',
      surface: 'JD含「高温补贴/防暑降温费」。',
      meaning: '部分地区/行业法定或企业福利，金额通常不大，是合规性或福利加分项。',
      risk: 'low',
      advice: '确认发放月份与标准即可，作为福利了解，不构成选岗决定性因素。',
    },
    '员工宿舍': {
      category: 'jd',
      surface: 'JD含「提供员工宿舍/住宿补贴」。',
      meaning: '解决住宿可降低成本，但宿舍条件/管理/距公司远近影响实际体验。',
      risk: 'medium',
      advice: '问清宿舍条件、是否收费、离公司通勤时间，避免「省房租」变「赔体验」。',
    },
    '工龄工资': {
      category: 'jd',
      surface: 'JD含「工龄工资/年资奖励」。',
      meaning: '体现「做越久越值钱」的留人导向，适合长期稳定型，但可能涨薪缓慢。',
      risk: 'medium',
      advice: '结合行业看工龄工资占比，判断是稳定累积还是变相锁人，与晋升空间权衡。',
    },
    '季度奖金': {
      category: 'jd',
      surface: 'JD含「季度奖金/绩效奖金」。',
      meaning: '说明有浮动薪酬，激励导向，但奖金与业绩/考核挂钩，非固定收入。',
      risk: 'medium',
      advice: '问清考核指标、发放比例与是否有上限，别把「有奖金」当「稳定高薪」。',
    },
    '你的同学怎么评价你': {
      category: 'interview',
      surface: '面试官问「你的同学/朋友怎么评价你」。',
      meaning: '想了解你的真实性格与人际表现，借第三方视角验证自我认知。',
      risk: 'low',
      advice: '给出同学常评价你的1-2个正面特点+具体场景，避免只说「挺好」「人缘好」。',
    },
    '你如何平衡工作和生活': {
      category: 'interview',
      surface: '面试官问「你如何平衡工作和生活」。',
      meaning: '考察你对加班的接受度与自我管理，也隐含工作量可能较大的信号。',
      risk: 'medium',
      advice: '表明你会用效率与边界平衡，但别过度承诺完全接受加班，留余地。',
    },
    '你为什么离开上家公司': {
      category: 'interview',
      surface: '面试官问「你为什么离开上家公司」。',
      meaning: '核心是离职动机稳定性，想判断你是否会在新公司同样离开。',
      risk: 'high',
      advice: '只谈客观/成长驱动（如赛道、发展），别抱怨前公司，给自洽的离职逻辑。',
    },
    '你觉得你适合这个岗位吗': {
      category: 'interview',
      surface: '面试官问「你觉得你适合这个岗位吗」。',
      meaning: '测试你对自己与岗位的匹配认知，想听你客观评估而非盲目自信。',
      risk: 'medium',
      advice: '用「岗位要求+你的能力+缺口弥补」三点作答，承认差距但给出补足路径。',
    },
    '你怎么看待直属领导': {
      category: 'interview',
      surface: '面试官问「你怎么看待直属领导/你理想的领导」。',
      meaning: '反映你的协作偏好与往上管理能力，也看是否好相处。',
      risk: 'low',
      advice: '强调尊重、配合、能沟通，别评价前领导好坏，给具体可协作的期望。',
    },
    '发表论文': {
      category: 'resume',
      surface: '简历写「发表论文/期刊论文」。',
      meaning: '学术成果背书，对科研/研究岗或升学重要，但对多数工程岗属于加分非核心。',
      risk: 'low',
      advice: '写清期刊/会议级别与是否一作，普通岗位不必过度展开，突出能力转化。',
    },
    '申请专利': {
      category: 'resume',
      surface: '简历写「申请专利/发明专利」。',
      meaning: '创新与技术能力的高级证明，对研发/技术岗价值显著。',
      risk: 'low',
      advice: '写明专利名称或编号，突出你在其中的技术贡献，别只列「有专利」。',
    },
    '国家级奖项': {
      category: 'resume',
      surface: '简历写「国家级/省级奖项」。',
      meaning: '高含金量的能力背书，能快速建立信任，但需与岗位相关才有效。',
      risk: 'medium',
      advice: '结合岗位说明奖项体现的能力（竞赛/技术/团队），避免堆砌无关获奖。',
    },
    '担任部长': {
      category: 'resume',
      surface: '简历写「担任部长/社团负责人」。',
      meaning: '体现组织协调与领导力，但需落到具体成果才不空泛。',
      risk: 'low',
      advice: '补充「组织过什么活动、达到什么效果」，把职务翻译成可量化贡献。',
    },
    '你来牵头': {
      category: 'workplace',
      surface: '领导说「这个你来牵头/负责推进」。',
      meaning: '授予你主导权，也把责任压给你，好则成就在你、坏则背锅在你。',
      risk: 'medium',
      advice: '先明确目标、资源与协作方，同时争取支持，别独自硬扛再出问题。',
    },
    '先内部对齐': {
      category: 'workplace',
      surface: '同事/领导说「先内部对齐再说」。',
      meaning: '要求先在团队内统一意见，可能有分歧待协调，别急着对外承诺。',
      risk: 'medium',
      advice: '主动拉齐相关方观点，明确谁能拍板，避免对外口径不一致。',
    },
    '这个月绩效': {
      category: 'workplace',
      surface: '领导说「这个月绩效/这个月在考核」。',
      meaning: '提醒你关注当期考核与产出，可能意有所指，需自查是否达标或需重点交付。',
      risk: 'medium',
