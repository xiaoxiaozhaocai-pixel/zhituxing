...
export const ALL_INDUSTRY_RADAR: IndustryRadar[] = [
  ...
  },
  {
    ...
    redFlags: ['只懂产品名词，不懂硬件原理', '对成本与周期无概念', '把国货出海当口号，讲不出依据'],
    prepTips: ['补消费电子的硬件/结构/品质基础', '跟踪手机/智能硬件新品与产业新闻，标来源', '准备1个能讲深的硬件或电子项目'],
  },
  {
    key: 'optical',
    label: '光电/光学/显示',
  ...
  },
  {
    ...
    focus: [
      ...
      },
      {
        module: '业务/前沿判断',
        weight: 15,
        how: '考AI落地场景、智能体商业化、成本/合规、人才结构趋势判断。',
        questions: ['你怎么看大模型在企业的落地价值', 'AI落地有哪些成本和合规风险', '智能体(Agent)和聊天机器人有什么区别、企业该怎么用', '哪些行业会被AI最先改变、哪些岗位相对稳健'],
      },
    ],
    questions: [
      { question: '讲一个你用过的机器学习/大模型项目？', subtext: '看真实实践。', tip: '讲清数据、模型、评估指标与结果，别只讲用了什么框架。' },
      { question: '你怎么看大模型/AIGC的产业落地和风险？', subtext: '考前沿判断。', tip: '从智能体落地、成本/合规、行业复合趋势综合判断，避免只追热点。' },
      { question: 'Transformer的核心思想是什么？', subtext: '考基础原理。', tip: '讲注意力机制、自回归、并行计算，别只背名词。' },
    ],
    redFlags: ['只追AI热点不懂原理', '讲不出自己训过/调过的模型', '对算力成本/合规风险无概念', '只讲工具不懂智能体落地与商业验证', '对人才分化/行业复合趋势无判断'],
    prepTips: ['系统学机器学习/深度学习基础', '做一个能讲深的智能体或行业AI落地小项目', '关注大模型落地、成本/合规与行业复合趋势判断'],
  },
];
