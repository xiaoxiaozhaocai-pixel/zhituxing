...
const JOBS: JobEntry[] = [
  ...
  {
    id: 'sales_customer_manager',
    name: '销售/客户经理',
    category: '市场/销售',
    aliases: ['销售', '客户经理', '销售工程师', '大客户经理', '商务', '销售代表'],
    layers: [
      {
        layer: 'industry', label: '行业知识', weight: 20,
        items: [
          '销售全流程（线索→商机→报价→谈判→签单→回款）',
          '行业与客户画像（懂客户业务）',
          '产品/方案价值点',
          '招投标与商务流程',
        ],
    ...
    recommendCompanies: ['华为', '中兴', '大疆', '海康威视', '立讯精密', '工业/软件厂商'],
    studyPaths: {
      '商机管理': '学销售漏斗 + 模拟跟进一个商机（约1周）',
      '谈判': '学 SPIN/价值销售 + 模拟一次谈判（约1周）',
      'CRM': '了解主流 CRM + 录入一套销售数据（约3天）',
      '招投标': '学招投标流程 + 写一份标书框架（约1周）',
    },
  },
  {
    id: 'project_manager',
    name: '项目管理/项目专员',
    category: '项目管理',
    aliases: ['项目经理', '项目助理', '项目专员', '项目管理', 'PMO', '项目工程师', '实施顾问', '需求工程师'],
    layers: [
      {
        layer: 'industry', label: '行业知识', weight: 20,
        items: [
          '目标行业/业务的常识（懂用户场景）',
          '产品/项目全流程（需求→方案→排期→落地→复盘）',
          '行业竞品与趋势（能说清差异化）',
        ],
      },
      {
        ...
        items: [
          '需求分析与 PRD 撰写',
          '原型/流程图工具（Axure、ProcessOn、Figma）',
          '数据洞察与关键指标拆解',
          '项目排期与推进（甘特图、里程碑、验收）',
          '跨部门协调与落地推进',
        ],
    ...
    recommendCompanies: ['互联网/软件产品线', '智能制造成熟企业（项目/产品岗）', '企业信息化/HR SaaS', '硬件电子（产品经理）', '数字化咨询/实施'],
    studyPaths: {
      '需求分析': '学需求分析方法 + 从身边真实场景写一份PRD（约1-2周）',
      '原型': '学 Axure/ProcessOn + 画一套关键流程与原型（约1周）',
      '项目管理': '学项目五阶段 + 用甘特图排一个真实项目（约1周）',
      '数据': '学关键指标 + 拆一个功能的数据埋点（约3天）',
      '汇报': '学金字塔原理 + 做一次方案汇报（约3天）',
    },
  },
];
